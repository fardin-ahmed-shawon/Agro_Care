    <footer>
        <div class="container">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul>
                        ...
                        <li><a href="testimonials.php"><i class="fas fa-chevron-right"></i> Testimonials</a></li>
                ...
                <div class="footer-col">
                    <h3>Services</h3>
                    <ul>
                        <li><a href="services.php"><i class="fas fa-chevron-right"></i> Market Access</a></li>
                        <li><a href="services.php"><i class="fas fa-chevron-right"></i> Financial Services</a></li>
                        <li><a href="services.php"><i class="fas fa-chevron-right"></i> Training Programs</a></li>
                        <li><a href="services.php"><i class="fas fa-chevron-right"></i> Equipment Rental</a></li>
                        <li><a href="services.php"><i class="fas fa-chevron-right"></i> Weather Alerts</a></li>
                    </ul>
                </div>
                <div class="footer-col">
                    <h3>Contact Us</h3>
            ...
            <div class="copyright">
                <p>© 2023 FarmerCare. All Rights Reserved. | <a href="#" style="color: var(--primary);">Privacy Policy</a> | <a href="#" style="color: var(--primary);">Terms of Service</a></p>
            </div>
        </div>
    </footer>